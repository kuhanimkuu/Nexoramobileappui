          ...
          <div className="px-4 pb-4">
            <div className="flex items-end justify-between -mt-16 mb-4">
              ...
              <div className="flex gap-2 mb-2">
                ...
                <Button variant="outline" onClick={onSettings} className="border-2 px-3">
            ...
            <div className="mb-4">
              ...
              <p className="text-text-secondary mb-2">{currentUser.username}</p>
              <p className="text-text-primary">{currentUser.bio}</p>
            </div>
            ...
            <div className="flex gap-6">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-semibold text-text-primary">248</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-semibold text-text-primary">32</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-semibold text-text-primary">12</p>
