          ...
          <div>
            ...
            {options.length < 6 && (
              <Button
                onClick={addOption}
                variant="outline"
                className="mt-3 w-full h-12 border-2 border-dashed border-border-light hover:border-nexora-blue hover:bg-nexora-blue/5"
              >
            ...
            <p className="text-text-muted mt-2">
              Add 2-6 options for people to choose from
            </p>
          </div>
        </div>
      </main>
