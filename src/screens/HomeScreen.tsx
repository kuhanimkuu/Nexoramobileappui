...
export function HomeScreen({ onCreatePost, onNotifications, onPostDetail }: HomeScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-soft-white dark:bg-dark-bg pb-20">
      {/* Header */}
      <header className="sticky top-0 bg-white/95 dark:bg-dark-surface/95 backdrop-blur-sm border-b border-border-light dark:border-dark-border z-40">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 hover:bg-soft-white dark:hover:bg-dark-surface-elevated rounded-full transition-colors relative"
            >
              <Bell className="w-5 h-5 text-text-secondary dark:text-dark-text-secondary" />
